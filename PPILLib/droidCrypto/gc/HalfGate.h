...
class GCEnv {
 public:
  GCEnv(ChannelWrapper &chan)
      : channel(chan), gb(), gid(0), numANDs(0), numXORs(0), timeGarbling(0), timeEvaluation(0) {}
  ...
  std::chrono::duration<double> timeGarbling;
  std::chrono::duration<double> timeEvaluation;
