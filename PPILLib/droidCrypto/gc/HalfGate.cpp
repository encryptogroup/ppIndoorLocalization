...
WireLabel Garbler::XOR(const WireLabel &a, const WireLabel &b) {
  ...
  timeGarbling = timeGarbling + (time2 - time1);
  return r;
}
...
WireLabel Garbler::AND(const WireLabel &a, const WireLabel &b) {
  ...
  numANDs++;
    ...
    auto time2 = std::chrono::high_resolution_clock::now();
    timeGarbling = (time2 - time1) + timeGarbling;
  TG.send(channel);
  TE.send(channel);
...
WireLabel Garbler::NOT(const WireLabel &a) {
    auto time1 = std::chrono::high_resolution_clock::now();
    WireLabel r = a ^ R;
    auto time2 = std::chrono::high_resolution_clock::now();
    timeGarbling = timeGarbling + (time2 - time1);
...
WireLabel Evaluator::XOR(const WireLabel &a, const WireLabel &b) {
  ...
  WireLabel res = a ^ b;
  auto time2 = std::chrono::high_resolution_clock::now();
  timeEvaluation = timeEvaluation + (time2 - time1);
  return res;
}
...
WireLabel Evaluator::AND(const WireLabel &a, const WireLabel &b) {
  ...
  numANDs++;
    auto time2 = std::chrono::high_resolution_clock::now();
    timeEvaluation = (time2 - time1) + timeEvaluation;
  return WG ^ WE;
}
