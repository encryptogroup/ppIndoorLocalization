...
Java_com_example_ppil_LibTask_testNative(
        JNIEnv* env,
...
extern "C"
JNIEXPORT void JNICALL Java_com_example_ppil_LibTask_testSend
...
extern "C"
JNIEXPORT void JNICALL Java_com_example_ppil_LibTask_testRecv
  (JNIEnv *env, jobject thisObj, jobject channel) {
    uint8_t test[4] = {0,};
